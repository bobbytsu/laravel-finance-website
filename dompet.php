...
<body>
	...
	<div class="container row justify-content-center">
		<div class="row text-center">
			<div class="col-12">
				...
				<form action="dompet.php" method="post" class="form-inline">
	...
	<?php
			...
			$sql = "SELECT * FROM transactions WHERE '$username' = username AND tanggal LIKE '$tanggal%' ORDER BY tanggal DESC";
			$results = mysqli_query($db, $sql);
